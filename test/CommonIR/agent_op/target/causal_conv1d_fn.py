...
def _causal_conv1d_fwd_kernel(  # continuous batching
    ...
    if IS_APC_ENABLED:
        ...
        # If aligned to stride_cache_chunk, the last full chunk is the second-to-last one
        if seq_end_offset == 0:
    ...
    if chunk_offset == 0:
        ...
        if (
            ...
            if load_init_state:
                ...
                # tl.debug_barrier()  # need this due to the bug in tl.where not enforcing
                # this when data is the result of another tl.load
        ...
        # For example:
        # If n_block_to_fill = 0, only the state at the sequence end is cached.
